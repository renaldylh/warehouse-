...
import { Mail, Lock, UserPlus, ChevronRight, User } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl shadow-slate-200 border border-slate-100 overflow-hidden relative z-10">
        <div className="p-8 pb-4 text-center">
          ...
          <p className="text-slate-500 mt-2 font-medium">Bergabung dengan WMS Disro Baju</p>
        </div>
           ...
           <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input 
                ...
                className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 transition-all text-slate-800 font-medium"
              />
            </div>
          </div>
